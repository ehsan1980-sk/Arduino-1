...
byte mac[] = { 0x90, 0xA2, 0xDA, 0x00, 0x26, 0xCC };  //Set your Ethernet Shield's MAC address here - make sure you replace the MAC Address with your shield's values!
byte ip[] = { 10,20,31,33 };                        // Set your shield's desired IP address here - check your network for configuration details
...
IPAddress iPhoneIP(66,192,104,13);               //Leave it as its is  //Set the iPhone/iPod/iPad's IP address to send messages back to iArduino...
